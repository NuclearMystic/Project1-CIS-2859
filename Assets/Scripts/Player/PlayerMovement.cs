...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        UIController.Instance.speedEffect.SetActive(true);
        walkSpeed += boostAmount;
        runSpeed += boostAmount;
        yield return new WaitForSeconds(duration);
        walkSpeed = originalWalkSpeed;
        runSpeed = originalRunSpeed;
       UIController.Instance.speedEffect.SetActive(false);
    ...
    {
        UIController.Instance.jumpEffect.SetActive(true);
        jumpHeight += boostAmount;
        yield return new WaitForSeconds(duration);
        jumpHeight = originalJumpHeight;
       UIController.Instance.jumpEffect.SetActive(false);
